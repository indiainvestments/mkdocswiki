...
-   **Distributors are Inherently Biased Against the Investor**
    ...
    We’ve got the data about AUM distribution from [this](https://www.miraeassetmf.co.in/docs/default-source/other-disclosure/average-asset-under-management-(aaum)-disclosure---february-2021.xlsb?sfvrsn=90523d20_2) link on [this](https://www.miraeassetmf.co.in/downloads/statutory-disclosure/other-disclosure) page. You’ll need to search for similar links on other AMC websites.
...
![Regular Plan Returns Trailing by 1% - Dark Mode](/images/difference-direct-regular-one-percent.dark%20(1).png){.dark-mode-image}

![Regular Plan Returns Trailing by 1% - Light Mode](/images/difference-direct-regular-one-percent.light%20(1).png){.light-mode-image}

If the difference in CAGR is assumed to be $$1.5\%$$, this is how the corpus changes.

![Regular Plan Returns Trailing by 1.5% - Dark Mode](/images/difference-direct-regular-one-point-five.dark%20(1).png){.dark-mode-image}

![Regular Plan Returns Trailing by 1.5% - Light Mode](/images/difference-direct-regular-one-point-five.light%20(1).png){.light-mode-image}
