...
This is effectively *normalized time*. Given two dates $$t$$ and $$t_0$$, $$(t - t_0)$$ is equivalent to number of days in between those two dates. And $$\Delta T$$ is a common factor (commonly, 1 year or 365 days).
