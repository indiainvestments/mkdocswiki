...
![NASDAQ Chart - Dark Mode](/images/nasdaq-chart.dark.png){.dark-mode-image}

![NASDAQ Chart - Light Mode](/images/nasdaq-chart.light.png){.light-mode-image}
...
![Table Columns (dark mode)](/images/table-columns.dark.png){.dark-mode-image}

![Table Columns (light mode)](/images/table-columns.light.png){.light-mode-image}
...
![Using INDEX to Extract Value from a Position (Dark Mode)](/images/index-function.dark.png){.dark-mode-image}

![Using INDEX to Extract Value from a Position (Light Mode)](/images/index-function.light.png){.light-mode-image}
...
![Final Tally - Dark Mode](/images/final-tally.dark.png){.dark-mode-image}

![Final Tally - Light Mode](/images/final-tally.light.png){.light-mode-image}
