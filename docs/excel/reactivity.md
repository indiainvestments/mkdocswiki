...
-   Start by adding an equal-to symbol, or `=`. In Excel, an `=` starts a *formula* or relationship.
...
Well, fear not, this is where Excel’s famous *drag operation* comes in ![:accept:](https://assets.hackmd.io/build/emojify.js/dist/images/basic/accept.png)
