...
*CSV* stands for **C**omma **S**eparated **V**alues. It’s a text file, which has entries, separated by comma (`,`).
...
{% file src="../../.gitbook/assets/test.csv" %}
test.csv
{% endfile %}
...
This *magic* needed some DIY (**D**o **I**t **Y**ourself) explanation.
